...
class _NewItemState extends State<NewItem> {
  ...
  void _saveItem() async {
    if (_formKey.currentState!.validate()) {
     ...
     final url = Uri.https('flutter-demo-a6dde-default-rtdb.firebaseio.com', 'shopping-list.json');
      ...
      try {
        ...
        if (response.statusCode == 200 || response.statusCode == 201) {
          // Nếu thành công, thêm item vào danh sách và quay lại màn hình trước
